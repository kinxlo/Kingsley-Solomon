  ...
  return (
      ...
      >
          ...
          <Box className='step-1'>
              ...
              >
                  <Flex className='step-2' flexDir={`column`} justifyContent={{ base: `space-between` }}>
                      ...
                      <Box width={`fit-content`}>
                          ...
                          <Box className='action-btn' width={`fit-content`}>
                              <Link
                                  ...
                                  target={`_blank`}
                                  href='https://drive.google.com/file/d/1d_tJETabFKKXVb7E3_O9xQUYCnJ46_Da/view?usp=drive_link'
                              >
                                  <Box className={`quil_box action-btn`} title={`Experience as a Web developer`} width={`5rem`}>
                                      <Image
