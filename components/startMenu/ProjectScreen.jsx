import { Box, Link, Image, Flex, Text, useColorMode, Button } from "@chakra-ui/react";
    ...
    return (
        ...
        >
            <Box className='slide-in' display={{ base: `none`, lg: `block` }}>
                <Text color={`accent`} className='font-mono' textTransform={`capitalize`} fontWeight={`bold`} fontSize={{ base: `md`, md: `2xl` }}>
                    {projectInfo.name}
                </Text>
                <Text fontWeight={`bold`} fontSize={`xs`} color={`accent`} textAlign='left'>
            ...
            <Text color={`accent`} mt='2' fontStyle={`italic`} fontSize={`xs`}>
                ...
                The approximate figure above shows how much of the language or framework was utilized throughout the project&apos;s development. It in no way
            ...
            <Flex width={`100%`} justifyContent={`space-between`} mt={5}>
                ...
                >
                    <Text fontSize={`xs`}>
                        {projectInfo.status?.includes(`Development`) ? `Interact with this app in development mode` : `Interact with this app`}{" "}
                    </Text>
                    <Box
                        ref={url}
                        ...
                        p={`3px`}
                    >
                        <Image width={`100%`} height={`100%`} alt='img' src='https://img.icons8.com/officel/30/000000/cloud-link--v1.png' />
                    </Box>
                </Button>
                {/*  */}
                {/* <Flex
