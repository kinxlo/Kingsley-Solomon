      ...
      <Box id='container--main'>
        ...
        >
          <div>
            ...
            <Text my={2}>
              ...
              Demonstrated talent for frontend web
              development to optimize online presence. A
              maestro in frameworks such as React and Vue,
              as well as scripting languages such as
              JavaScript.
            </Text>
        ...
        <section className='section--page'>
          ...
          <ul id='qualifications--list'>
            ...
            <li>
              ✔️ Good knowledge in API Implementation.
            </li>
          </ul>
        </section>
