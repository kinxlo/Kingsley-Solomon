...
const Intro = () => {
  ...
  const [message] = useState(
    `I hear you are looking for a skilled web developer.`
  );
  ...
  return (
    ...
    >
      <Box>
        <Box className="text-top">{text_1}</Box>
        <Box alignItems={`baseline`} justifyContent={`center`}>
          <Text as={`span`} className={`letter msg`}>
            I
          </Text>
          <Text as={`span`} className={`letter msg`}>
            &nbsp;
          ...
          <Text id="lastElement" as={`span`} className={`msg letter`}>
            .
          </Text>
        </Box>
      </Box>
